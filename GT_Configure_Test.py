...
##        self.file_index = 0
    ...
    def setup_repos(self, config_file, active_row, my_repository):
        ...
        print(my_repository.etu_dictionary)
    ...
    def get_new_vars(self, config_file, active_row):
        ...
        while True:
            k = config_file.read_cell(col, active_row, 0)
            if k == None:
                break
                ...
                for run in range(0, max_runs): 
                    ...
                    for key in keys:
                        if key in new_vars:
                            ...
                            max_val = new_vars[key_num+1]
                            interval = new_vars[key_num+3]
    ##                        print("Key " + key)
    ##                        print("Interval " + str(interval))
    ##                        print("max_val " +str(max_val))
                            

                            write_val = my_repository.etu_dictionary[key][0] + interval 
    ##                        print(write_val)
                            ...
                            if key == "I A (PU)":
                                amps = write_val * my_repository.etu_dictionary["LD PU"][0]/100 * my_repository.etu_dictionary["Rating"][0]
    ...
    def rename_file(self, base_test_name, base_test, new_vars, frame, rating):
        ...
        for i in range(0, num_runs):
            ...
            str_tag = str_tag + "(" + str(var_name) + "=" + file_name_val + ")"
    ...
    def start(self, my_repository):
        ...
        while True :
            ...
            if base_test_name == "" or base_test_name == None:
                break

            new_test_name =  save_file_dir + base_test_name            
            base_test_name = "Z:\\Arisumi\\Programs\\General Test 3.6\\Tests\\Default Tests\\Generic\\" + base_test_name
