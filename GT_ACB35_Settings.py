...
def add_setpoint_group_seven(repos):
    ...
    add_dictionary_values(repos, repos.sp_seven_keys)
...
def add_buffer_fourty_eight(repos):
    ...
    repos.etu_dictionary["V LL Average"]      =  [0,"Float"]
...
def add_buffer_fifty(repos):
    ...
    repos.etu_dictionary['Last PD Reset TS']                = [0, "Date35"]
    ...
    repos.etu_dictionary['Max Real Power Demand TS']        = [0, "Date35"]
    repos.etu_dictionary['Max Reactive Power Demand']       = [0, "Float"]
    repos.etu_dictionary['Max Reactive Power Demand TS']    = [0, "Date35"]
    repos.etu_dictionary['Max Apparent Power Demand']       = [0, "Float"]
    repos.etu_dictionary['Max Apparent Power Demand TS']    = [0, "Date35"]
...
def add_buffer_fifty_one(repos):
    ...
    repos.buffer_fifty_one_keys =   ['Real Power A',
                                 'Real Power B',
                                 'Real Power C',
                                 'Real Power Total',
                                 'Reactive Power A',
...
def add_buffer_fifty_two(repos):
    ...
    repos.etu_dictionary['Max IA']              = [0, "Float"]
    repos.etu_dictionary['Max IA TS']           = [0, "Date35"]
    repos.etu_dictionary['Max IB']              = [0, "Float"]
    repos.etu_dictionary['Max IB TS']           = [0, "Date35"]
    repos.etu_dictionary['Max IC']              = [0, "Float"]
    repos.etu_dictionary['Max IC TS']           = [0, "Date35"]   
    repos.etu_dictionary['Max IN']              = [0, "Float"]
    repos.etu_dictionary['Max IN TS']           = [0, "Date35"]
    repos.etu_dictionary['Max IG']              = [0, "Float"]
    repos.etu_dictionary['Max IG TS']           = [0, "Date35"]      
    repos.etu_dictionary['Min IA']              = [0, "Float"]
    repos.etu_dictionary['Min IA TS']           = [0, "Date35"]
    repos.etu_dictionary['Min IB']              = [0, "Float"]
    repos.etu_dictionary['Min IB TS']           = [0, "Date35"]
    repos.etu_dictionary['Min IC']              = [0, "Float"]
    repos.etu_dictionary['Min IC TS']           = [0, "Date35"]
    repos.etu_dictionary['Min IN']              = [0, "Float"]
    repos.etu_dictionary['Min IN TS']           = [0, "Date35"]
    repos.etu_dictionary['Min IG']              = [0, "Float"]
    repos.etu_dictionary['Min IG TS']           = [0, "Date35"]
    #repos.etu_dictionary['Last I Max-Min Reset TS']                = [0, "Date35"]
...
def add_buffer_fifty_four(repos):
     ...
     repos.etu_dictionary['Min Vcn1 TS']              = [0, "Date35"]
     repos.etu_dictionary['Max Van2']                 = [0, "Float"]
     repos.etu_dictionary['Max Van2 TS']              = [0, "Date35"]
     repos.etu_dictionary['Max Vbn2']                 = [0, "Float"]
     repos.etu_dictionary['Max Vbn2 TS']              = [0, "Date35"]
     repos.etu_dictionary['Max Vcn2']                 = [0, "Float"]
     repos.etu_dictionary['Max Vcn2 TS']              = [0, "Date35"]
     repos.etu_dictionary['Min Van2']                 = [0, "Float"]
     repos.etu_dictionary['Min Van2 TS']              = [0, "Date35"]
     repos.etu_dictionary['Min Vbn2']                 = [0, "Float"]
     repos.etu_dictionary['Min Vbn2 TS']              = [0, "Date35"]
     repos.etu_dictionary['Min Vcn2']                 = [0, "Float"]
     repos.etu_dictionary['Min Vcn2 TS']              = [0, "Date35"]
...
def add_buffer_sixty_one(repos):
    ...
    repos.mapping_dictionary['Buffer 61']    = [repos.buffer_sixty_one_keys,     "N/A" , "read_real_time_data_buffer_sixty_one_request"]
...
def add_buffer_sixty_five(repos):
    ...
    repos.mapping_dictionary['Buffer 65']    = [repos.buffer_sixty_five_keys,     "N/A" , "read_real_time_data_buffer_sixty_five_request"]
...
def add_buffer_sixty_nine(repos):
    ...
    repos.etu_dictionary['IA Unbalance Max TS']    = [0, "Date35"]
    repos.etu_dictionary['IB Unbalance Max']       = [0, "Float"]
    repos.etu_dictionary['IB Unbalance Max TS']    = [0, "Date35"]
    repos.etu_dictionary['IC Unbalance Max']       = [0, "Float"]
    repos.etu_dictionary['IC Unbalance Max TS']    = [0, "Date35"]
    repos.etu_dictionary['IAll Unbalance Max']     = [0, "Float"]
    repos.etu_dictionary['IAll Unbalance Max TS']  = [0, "Date35"]
    repos.etu_dictionary['VAllN Unbalance Max']    = [0, "Float"]
    repos.etu_dictionary['VAllN Unbalance Max TS'] = [0, "Date35"]
    repos.etu_dictionary['VAN Unbalance Max']      = [0, "Float"]
    repos.etu_dictionary['VAN Unbalance Max TS']   = [0, "Date35"]
    repos.etu_dictionary['VBN Unbalance Max']      = [0, "Float"]
    repos.etu_dictionary['VBN Unbalance Max TS']   = [0, "Date35"]
    repos.etu_dictionary['VCN Unbalance Max']      = [0, "Float"]
    repos.etu_dictionary['VCN Unbalance Max TS']   = [0, "Date35"]
    repos.etu_dictionary['VAll LL Unbalance Max']    = [0, "Float"]
    repos.etu_dictionary['VAll LL Unbalance Max TS'] = [0, "Date35"]
    repos.etu_dictionary['VAB Unbalance Max']        = [0, "Float"]
    repos.etu_dictionary['VAB Unbalance Max TS']     = [0, "Date35"]
    repos.etu_dictionary['VBC Unbalance Max']        = [0, "Float"]
    repos.etu_dictionary['VBC Unbalance Max TS']     = [0, "Date35"]
    repos.etu_dictionary['VCA Unbalance Max']        = [0, "Float"]
    repos.etu_dictionary['VCA Unbalance Max TS']     = [0, "Date35"]
    repos.etu_dictionary['I Total Unbalance Max']    = [0, "Float"]
    repos.etu_dictionary['I Total Unbalance Max TS'] = [0, "Date35"]
    repos.etu_dictionary['V Total Unbalance Max']    = [0, "Float"]
    repos.etu_dictionary['V Total Unbalance Max TS'] = [0, "Date35"]
...
def add_buffer_seventy(repos):
    ...
    repos.etu_dictionary['Ia Current Crest Factor']=[0, "Q8Padded"]
    repos.etu_dictionary['Ib Current Crest Factor']=[0, "Q8Padded"]
    repos.etu_dictionary['Ic Current Crest Factor']=[0, "Q8Padded"]
    repos.etu_dictionary['In Current Crest Factor']=[0, "Q8Padded"]
...
def add_buffer_seventy_one(repos):
    ...
    repos.etu_dictionary["Min Apparent PF TS"] = [0, "Date35"]
    repos.etu_dictionary["Max Apparent PF"]    = [0, "Float"]
    repos.etu_dictionary["Max Apaprent PF TS"] = [0, "Date35"]
    repos.etu_dictionary["Min Disp PF"]    = [0, "Float"]
    repos.etu_dictionary["Min Disp PF TS"] = [0, "Date35"]
    repos.etu_dictionary["Max Disp PF"]    = [0, "Float"]
    repos.etu_dictionary["Max Disp PF TS"]    = [0, "Date35"]
    repos.etu_dictionary["Min Apparent A PF"]    = [0, "Float"]
    repos.etu_dictionary["Min Apparent A PF TS"] = [0, "Date35"]
    repos.etu_dictionary["Max Apparent A PF"]    = [0, "Float"]
    repos.etu_dictionary["Max Apaprent A PF TS"] = [0, "Date35"]                                      
    repos.etu_dictionary["Min Apparent B PF"]    = [0, "Float"]
    repos.etu_dictionary["Min Apparent B PF TS"] = [0, "Date35"]
    repos.etu_dictionary["Max Apparent B PF"]    = [0, "Float"]
    repos.etu_dictionary["Max Apaprent B PF TS"] = [0, "Date35"]
    repos.etu_dictionary["Min Apparent C PF"]    = [0, "Float"]
    repos.etu_dictionary["Min Apparent C PF TS"] = [0, "Date35"]
    repos.etu_dictionary["Max Apparent C PF"]    = [0, "Float"]
    repos.etu_dictionary["Max Apaprent C PF TS"] = [0, "Date35"]
    repos.etu_dictionary["Min Disp A PF"]    = [0, "Float"]
    repos.etu_dictionary["Min Disp A PF TS"] = [0, "Date35"]
    repos.etu_dictionary["Max Disp A PF"]    = [0, "Float"]
    repos.etu_dictionary["Max Disp A PF TS"]    = [0, "Date35"]
    repos.etu_dictionary["Min Disp B PF"]    = [0, "Float"]
    repos.etu_dictionary["Min Disp B PF TS"] = [0, "Date35"]
    repos.etu_dictionary["Max Disp B PF"]    = [0, "Float"]
    repos.etu_dictionary["Max Disp B PF TS"]    = [0, "Date35"]
    repos.etu_dictionary["Min Disp C PF"]    = [0, "Float"]
    repos.etu_dictionary["Min Disp C PF TS"] = [0, "Date35"]
    repos.etu_dictionary["Max Disp C PF"]    = [0, "Float"]
    repos.etu_dictionary["Max Disp C PF TS"]    = [0, "Date35"]
    repos.etu_dictionary["Min Apparent Total PF"]    = [0, "Float"]
    repos.etu_dictionary["Min Apparent Total PF TS"] = [0, "Date35"]
    repos.etu_dictionary["Max Apparent Total PF"]    = [0, "Float"]
    repos.etu_dictionary["Max Apaprent Total PF TS"] = [0, "Date35"]
    repos.etu_dictionary["Min Disp Total PF"]    = [0, "Float"]
    repos.etu_dictionary["Min Disp Total PF TS"] = [0, "Date35"]
    repos.etu_dictionary["Max Disp Total PF"]    = [0, "Float"]
    repos.etu_dictionary["Max Disp Total PF TS"]    = [0, "Date35"]
...
def add_buffer_seventy_two(repos):
    ...
    repos.etu_dictionary["Freq Load Min TS"] = [0, "Date35"]
    repos.etu_dictionary["Freq Load Max"]    = [0, "Uint32"]
    repos.etu_dictionary["Freq Load Max TS"] = [0, "Date35"]
    repos.etu_dictionary["Freq Line Min"]    = [0, "Uint32"]
    repos.etu_dictionary["Freq Line Min TS"] = [0, "Date35"]
    repos.etu_dictionary["Freq Line Max"]    = [0, "Uint32"]
    repos.etu_dictionary["Freq Line Max TS"] = [0, "Date35"]
    repos.etu_dictionary["LD Bucket Max"]    = [0, "Uint32"]
    repos.etu_dictionary["LD Bucket Max TS"] = [0, "Date35"]
    repos.etu_dictionary["SD Bucket Max"]    = [0, "Uint32"]
    repos.etu_dictionary["SD Bucket Max TS"] = [0, "Date35"]
...
def add_buffer_seventy_four(repos):
    ...
    repos.etu_dictionary["Min Real Power A TS"] = [0, "Date35"]
    repos.etu_dictionary["Max Real Power A"]    = [0, "Float"]
    repos.etu_dictionary["Max Real Power A TS"] = [0, "Date35"]
    repos.etu_dictionary["Min Real Power B"]    = [0, "Float"]
    repos.etu_dictionary["Min Real Power B TS"] = [0, "Date35"]
    repos.etu_dictionary["Max Real Power B"]    = [0, "Float"]
    repos.etu_dictionary["Max Real Power B TS"]    = [0, "Float"]
    repos.etu_dictionary["Min Real Power C"]    = [0, "Float"]
    repos.etu_dictionary["Min Real Power C TS"] = [0, "Date35"]
    repos.etu_dictionary["Max Real Power C"]    = [0, "Float"]
    repos.etu_dictionary["Max Real Power C TS"] = [0, "Date35"]

    repos.mapping_dictionary['Buffer 74']    = [repos.buffer_seventy_four_keys,     "N/A" , "read_real_time_data_buffer_seventy_four_request"]
...
def add_buffer_seventy_five(repos):
    ...
    repos.etu_dictionary["Pwr Max RPa TS"]   = [0, "Date35"]
    repos.etu_dictionary["Pwr Min RPa"]      = [0,"Uint32"]
    repos.etu_dictionary["Pwr Min RPa TS"]   = [0, "Date35"]
    repos.etu_dictionary["Pwr Max RPb"]      = [0,"Uint32"]
    repos.etu_dictionary["Pwr Max RPb TS"]   = [0, "Date35"]
    repos.etu_dictionary["Pwr Min RPb"]      = [0,"Uint32"]
    repos.etu_dictionary["Pwr Min RPb TS"]   = [0, "Date35"]
    repos.etu_dictionary["Pwr Max RPc"]      = [0,"Uint32"]
    repos.etu_dictionary["Pwr Max RPc TS"]   = [0, "Date35"]
    repos.etu_dictionary["Pwr Min RPc"]      = [0,"Uint32"]
    repos.etu_dictionary["Pwr Min RPc TS"]   = [0, "Date35"]
    repos.etu_dictionary["Pwr Max RPtot"]    = [0,"Uint32"]
    repos.etu_dictionary["Pwr Max RPtot TS"] = [0, "Date35"]
    repos.etu_dictionary["Pwr Min Rtot"]    = [0,"Uint32"]
    repos.etu_dictionary["Pwr Min Rtot TS"] = [0, "Date35"]
...
def add_buffer_seventy_six(repos):
    ...
    repos.etu_dictionary["Pwr Max AppPa TS"]   = [0, "Date35"]
    repos.etu_dictionary["Pwr Min AppPa"]      = [0,"Uint32"]
    repos.etu_dictionary["Pwr Min AppPa TS"]   = [0, "Date35"]
    repos.etu_dictionary["Pwr Max AppPb"]      = [0,"Uint32"]
    repos.etu_dictionary["Pwr Max AppPb TS"]   = [0, "Date35"]
    repos.etu_dictionary["Pwr Min AppPb"]      = [0,"Uint32"]
    repos.etu_dictionary["Pwr Min AppPb TS"]   = [0, "Date35"]
    repos.etu_dictionary["Pwr Max AppPc"]      = [0,"Uint32"]
    repos.etu_dictionary["Pwr Max AppPc TS"]   = [0, "Date35"]
    repos.etu_dictionary["Pwr Min AppPc"]      = [0,"Uint32"]
    repos.etu_dictionary["Pwr Min AppPc TS"]   = [0, "Date35"]
    repos.etu_dictionary["Pwr Max Apptot"]    = [0,"Uint32"]
    repos.etu_dictionary["Pwr Max Apptot TS"] = [0, "Date35"]
    repos.etu_dictionary["Pwr Min Apptot"]    = [0,"Uint32"]
    repos.etu_dictionary["Pwr Min Apptot TS"] = [0, "Date35"]
...
def add_buffer_seventy_seven(repos):
    ...
    repos.etu_dictionary['Demand Reset TS'] = [0, "Date35"]
    ...
    repos.etu_dictionary['Max Ia Demand TS'] = [0, "Date35"]
    repos.etu_dictionary['Max Ib Demand'] = [0, "Float"]
    repos.etu_dictionary['Max Ib Demand TS'] = [0, "Date35"]
    repos.etu_dictionary['Max Ic Demand'] = [0, "Float"]
    repos.etu_dictionary['Max Ic Demand TS'] = [0, "Date35"]
    repos.etu_dictionary['Max In Demand'] = [0, "Float"]
    repos.etu_dictionary['Max In Demand TS'] = [0, "Date35"]
    repos.etu_dictionary['Min Ia Demand'] = [0, "Float"]
    repos.etu_dictionary['Min Ia Demand TS'] = [0, "Date35"]
    repos.etu_dictionary['Min Ib Demand'] = [0, "Float"]
    repos.etu_dictionary['Min Ib Demand TS'] = [0, "Date35"]
    repos.etu_dictionary['Min Ic Demand'] = [0, "Float"]
    repos.etu_dictionary['Min Ic Demand TS'] = [0, "Date35"]
    repos.etu_dictionary['Min In Demand'] = [0, "Float"]
    repos.etu_dictionary['Min In Demand TS'] = [0, "Date35"]                                               
    repos.etu_dictionary['Window Status'] = [0, "Uint16"]
    repos.etu_dictionary['Measurment Time'] = [0, "Uint16"]

    repos.mapping_dictionary['Buffer 77']    = [repos.buffer_seventy_seven_keys,     "N/A" , "read_real_time_data_buffer_seventy_seven_request"]
